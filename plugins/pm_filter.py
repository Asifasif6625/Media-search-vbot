...
BUTTONS = {}
BOT = {}
@Client.on_message(filters.text & filters.private & filters.incoming & filters.user(AUTH_USERS) & ~filters.user(BANNED_USERS) if AUTH_USERS else filters.text & filters.private & filters.incoming)
...
@Client.on_message(filters.text & filters.group & filters.incoming & filters.chat(AUTH_GROUPS) & ~filters.user(BANNED_USERS) if AUTH_GROUPS else filters.text & filters.group & filters.incoming)
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    ...
                    InlineKeyboardButton('Source Code ⚙️', url='https://t.me/Otthelpbot')
                ]
                ]
            await query.message.edit(text="<b>👩‍🎓 Developer : <a href='https://t.me/OTThelpbot'>Click Here</a>\n🔊 Language : Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\n⚙️🚫Source Code : <a href='https://t.me/otthelpbot'>Click here</a>\n📚 Update Channel : <a href='https://t.me/fileSearch1bots'>File Search Bot Updates</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
